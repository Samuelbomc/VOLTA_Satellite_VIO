...
print(f"Abriendo ROSBAG: '{BAG_PATH}'...")
    ...
    for connection, timestamp, rawdata in reader.messages():
            ...
            try:
                ...
                if msg.encoding in ['rgb8', 'bgr8']:
                    if img_array.size != width * height * 3:
                        print("Imagen corrupta (RGB), se omite")
                        continue
                    ...
                    if img_array.size != width * height:
                        print("Imagen corrupta (mono), se omite")
                        continue
                    img = img_array.reshape((height, width))

                else:
                    print(f"Encoding no soportado: {msg.encoding}")
                    continue
        ...
        # ================= IMU =================
            ...
            try:
                ...
                print(f"Error procesando IMU: {e}")
                continue
...
print(f"\n✅ ¡Conversión exitosa!")
print(f"Dataset listo en: '{OUTPUT_FOLDER}'")