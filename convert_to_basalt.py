...
def extract_bag(bag_path, out_dir):
    ...
    with Reader(bag_path) as reader:
        for connection, timestamp, rawdata in reader.messages():
            ...
            # --- CAMERA (Simulación matemática del ROI del Sony IMX296) ---
                ...
                if msg.encoding == 'rgb8':
                    ...
                    # Asumimos que el diámetro del círculo de 180° ocupa el lado más corto en Isaac Sim
                    full_circle_diameter = min(h, w)
                    
                    # Aplicamos el ratio físico (3.75mm / 4.90mm) para obtener 137.7°
                    ratio = 3.75 / 4.90
                    ...
                    # Aplicar el recorte (Crop) que elimina los bordes del círculo
